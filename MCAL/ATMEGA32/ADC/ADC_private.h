...
#define ADMUX_REG 		HWREG8(0x27)
#define ADCSRA_REG 		HWREG8(0x26)
#define ADCH_REG		HWREG8(0x25)
#define ADCL_REG		HWREG8(0x24)
#define SFIOR_REG		HWREG8(0x50)
#define ADC_DATA		HWREG16(0x24)
